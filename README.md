...
**ClipAI** is a simple but powerful utility to connect your **clipboard** 📋 directly to a **LOCAL LLM** 🤖 (Ollama-based) such as **Gemma 3**, **Phi 4**, **Deepseek-V3**, **Qwen**, **Llama 3.x**, etc. It is a **clipboard viewer** 👁️ and **text transformer** 🔁 application built using **Tkinter**. It allows users to:
